 ...
 */
@WebServlet("/FrontEnd5")
public class FrontEndUltraFancier extends HttpServlet {
...
//		DBConnection.init();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form action= 'FrontEnd5' method= 'post'>");
...
//		out.println("<form action= 'FrontEnd5' method= 'post'>");
		...
		out.println("<h2 style='font-size:30px; text-align:center; display:block;' id='recommendationText'>Recommendation</h2>");
...
//			recommendedMovies[1]= Movie.getMovieByName(movies, "shrek 2", false);
			...
			for(int i= 0; i< recommendedMovies.length; i++) {
				...
				out.println("<div class=\"mySlides fade\">");
					out.println("<b style='font-size:20px;'>"+m1.getName() + "</b><br>");
					out.println("<div class='recommendedCard'>");
						out.println("<img src='"+ poster+ "'>");
						out.println("<p style='padding-left: 10px;'>"+desc+"</p>");
					out.println("</div>");
					

					out.println("<b>Rating  :</b>"+ recommendedMovies[i].getAverageRating()+ "<br>");
					out.println("<b>Votes   :</b>"+ recommendedMovies[i].getNumberOfVotes()+ "<br>");
					out.println("<b>Year    :</b>"+ recommendedMovies[i].getYearOfRelease()+ "<br>");
					out.println("<b>Length  :</b>"+ recommendedMovies[i].getLength()+ "<br>");
					out.println("<b>Region  :</b>"+ recommendedMovies[i].getLanguage()+ "<br>");
					out.println("<b>Genres  :</b>");
					for(Genre genre: recommendedMovies[i].getGenres())	out.println(genre + " ");
					out.println("<br>");
			...
			for(int i= 0; i< recommendedMovies.length; i++) {
				...
				out.println("<div class=\"mySlides fade\">");
					...
					out.println("<p style='padding-left: 10px;'>"+desc+"</p><br>");
					out.println("<b>Rating  :</b>"+ recommendedMovies[i].getAverageRating()+ "<br>");
					out.println("<b>Votes   :</b>"+ recommendedMovies[i].getNumberOfVotes()+ "<br>");
					out.println("<b>Year    :</b>"+ recommendedMovies[i].getYearOfRelease()+ "<br>");
					out.println("<b>Length  :</b>"+ recommendedMovies[i].getLength()+ "<br>");
			...
			out.println("<div style=\"text-align:center; position: relative;\">");	//	START DOTS
