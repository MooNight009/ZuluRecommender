 ...
 */
@WebServlet("/FrontEnd3")
public class FrontEndFanciest extends HttpServlet {
...
//			}
			...
			recommendedMovies= new Movie[1];
			recommendedMovies[0]= Movie.getMovieByName(movies, "shrek", false);
			
			
			
			//	START COMPACT
			out.println("<div id='Compact' class='tabcontent'>");
			for(int i= 0; i< recommendedMovies.length; i++) {
				if(recommendedMovies[i]== null)	continue;
				out.println("<b>"+ (i+ 1)+ ". </b>"+ recommendedMovies[i].getName());
				out.println("<br><br>");
			...
			//	START CARD
			out.println("<div id='Card' class='tabcontent'>");
